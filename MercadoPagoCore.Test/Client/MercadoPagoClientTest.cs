namespace MercadoPagoCore.Tests.Client
{
    ...
    using MercadoPagoCore.Tests.Http;
    using MercadoPagoCore.Tests.Resource;
    using Xunit;
    ...
    public class MercadoPagoClientTest
    {
        ...
        public void Send_WithBody_Success()
        {
            ...
            DummyResource dummyResource =
                client.Send(path, MercadoPagoCore.Http.HttpMethod.Post, request);
        ...
        public async Task SendAsync_WithoutBody_Success()
        {
            ...
            DummyResource dummyResource =
                await client.SendAsync(path, MercadoPagoCore.Http.HttpMethod.Get, null);
        ...
        public void Send_WithoutBody_Success()
        {
            ...
            DummyResource dummyResource =
                client.Send(path, MercadoPagoCore.Http.HttpMethod.Get, null);
        ...
        public async Task SendAsync_WithQueryString_Success()
        {
            ...
            DummyResource dummyResource =
                await client.SendAsync(path, MercadoPagoCore.Http.HttpMethod.Get, request);
        ...
        public async Task ListAsync_Simple_Success()
        {
            ...
            ResourcesList<DummyResource> list =
                await client.ListAsync(path, MercadoPagoCore.Http.HttpMethod.Get, null);
        ...
        public void List_Simple_Success()
        {
            ...
            ResourcesList<DummyResource> list =
                client.List(path, MercadoPagoCore.Http.HttpMethod.Get, null);
