...
using MercadoPagoCore.Resource.Customer;
using MercadoPagoCore.Serialization;

namespace MercadoPagoCore.Client.Customer
{
    /// <summary>
    /// Client with methods of Customers APIs.
    /// </summary>
    public class CustomerClient : MercadoPagoClient<Resource.Customer.Customer>
    {
        ...
        /// </param>
        public CustomerClient(IHttpClient httpClient, ISerializer serializer) : base(httpClient, serializer)
        {
        ...
        /// </summary>
        /// <param name="httpClient">The http client that will be used in HTTP requests.</param>
        public CustomerClient(IHttpClient httpClient) : this(httpClient, null)
        {
        }
        ...
        /// and to deserialize the HTTP response content.
        /// </param>
        public CustomerClient(ISerializer serializer) : this(null, serializer)
        {
        }
        ...
        /// Initializes a new instance of the <see cref="CustomerClient"/> class.
        /// </summary>
        public CustomerClient() : this(null, null)
        {
        }
        ...
        /// </remarks>
        public Task<Resource.Customer.Customer> GetAsync(
            string id,
        ...
        /// <a href="https://www.mercadopago.com/developers/en/reference/customers/_customers_id/get/">here</a>.
        /// </remarks>
        public Resource.Customer.Customer Get(
            string id,
            RequestOptions requestOptions = null)
        {
            return Send(
        ...
        /// </remarks>
        public Task<Resource.Customer.Customer> CreateAsync(
        ...
        /// <a href="https://www.mercadopago.com/developers/en/reference/customers/_customers/post/">here</a>.
        /// </remarks>
        public Resource.Customer.Customer Create(
            CustomerRequest request,
            RequestOptions requestOptions = null)
        {
            return Send(
        ...
        /// </remarks>
        public Task<Resource.Customer.Customer> UpdateAsync(
            string id,
            CustomerRequest request,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default)
        ...
        /// <a href="https://www.mercadopago.com/developers/en/reference//customers/_customers_id/put/">here</a>.
        /// </remarks>
        public Resource.Customer.Customer Update(
            string id,
            CustomerRequest request,
            RequestOptions requestOptions = null)
        {
        ...
        /// <a href="https://www.mercadopago.com/developers/en/reference/customers/_customers_id/get/">here</a>.
        /// </remarks>
        public Task<Resource.Customer.Customer> DeleteAsync(
            string id,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default)
        {
        ...
        /// <a href="https://www.mercadopago.com/developers/en/reference/customers/_customers_id/get/">here</a>.
        /// </remarks>
        public Resource.Customer.Customer Delete(
            string id,
            RequestOptions requestOptions = null)
        {
            return Send(
        ...
        /// </remarks>
        public Task<ResultsResourcesPage<Resource.Customer.Customer>> SearchAsync(
            SearchRequest request,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default)
        {
            return SearchAsync<ResultsResourcesPage<Resource.Customer.Customer>>(
                "/v1/customers/search",
                request,
                requestOptions,
                cancellationToken);
        ...
        /// <a href="https://www.mercadopago.com/developers/en/reference/customers/_customers_search/get/">here</a>.
        /// </remarks>
        public ResultsResourcesPage<Resource.Customer.Customer> Search(
            SearchRequest request,
            RequestOptions requestOptions = null)
        {
            return Search<ResultsResourcesPage<Resource.Customer.Customer>>(
                "/v1/customers/search",
                request,
                requestOptions);
        }
