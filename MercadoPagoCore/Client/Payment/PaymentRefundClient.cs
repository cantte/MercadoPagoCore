...
namespace MercadoPagoCore.Client.Payment
{
    ...
    public class PaymentRefundClient : MercadoPagoClient<PaymentRefund>
    {
        ...
        /// </param>
        public PaymentRefundClient(IHttpClient httpClient, ISerializer serializer) : base(httpClient, serializer)
        {
        }
        ...
        /// </summary>
        /// <param name="httpClient">The http client that will be used in HTTP requests.</param>
        public PaymentRefundClient(IHttpClient httpClient) : base(httpClient, null)
        {
        }
        ...
        /// and to deserialize the HTTP response content.
        /// </param>
        public PaymentRefundClient(ISerializer serializer) : base(null, serializer)
        {
        }
        ...
        /// Initializes a new instance of the <see cref="PaymentRefundClient"/> class.
        /// </summary>
        public PaymentRefundClient() : base(null, null)
        {
        }
