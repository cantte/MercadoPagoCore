...
using HttpMethod = MercadoPagoCore.Http.HttpMethod;
        ...
        where TResource : IResource, new()
    {
        ...
        protected IDictionary<string, string> DefaultHeaders =>
            new Dictionary<string, string>
            {
                ...
                [Headers.ProductId] = MercadoPagoConfig.ProductId,
                [Headers.UserAgent] = $"MercadoPagoCore DotNet SDK/{MercadoPagoConfig.Version}",
            };
        ...
        protected TResource Send(
            ...
            RequestOptions requestOptions = null)
        {
            return SendAsync(path, httpMethod, request, requestOptions)
        ...
        private static RequestOptions BuildRequestOptions(RequestOptions requestOptions)
        {
            ...
            requestOptions.RetryStrategy ??= MercadoPagoConfig.RetryStrategy;
        ...
        private static MercadoPagoApiException BuildInvalidResponseException(MercadoPagoResponse response)
        {
            return new("Invalid response from API.", response);
        }
    }
}
