...
namespace MercadoPagoCore.Client.AdvancedPayment
{
    ...
    public class AdvancedPaymentRefundClient : MercadoPagoClient<AdvancedPaymentDisbursementRefund>
    {
        ...
        /// </param>
        public AdvancedPaymentRefundClient(IHttpClient httpClient, ISerializer serializer) : base(httpClient, serializer)
        {
        }
        ...
        /// </summary>
        /// <param name="httpClient">The http client that will be used in HTTP requests.</param>
        public AdvancedPaymentRefundClient(IHttpClient httpClient) : this(httpClient, null)
        {
        }
        ...
        /// and to deserialize the HTTP response content.
        /// </param>
        public AdvancedPaymentRefundClient(ISerializer serializer) : this(null, serializer)
        {
        }
        ...
        /// Initializes a new instance of the <see cref="AdvancedPaymentClient"/> class.
        /// </summary>
        public AdvancedPaymentRefundClient() : this(null, null)
        {
        }
