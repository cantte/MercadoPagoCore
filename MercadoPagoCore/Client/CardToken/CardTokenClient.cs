...
namespace MercadoPagoCore.Client.CardToken
{
    /// <summary>
    /// Client to use Card Token API.
    /// </summary>
    public class CardTokenClient : MercadoPagoClient<Resource.CardToken.CardToken>
    {
        /// <summary>
        ...
        public Task<Resource.CardToken.CardToken> GetAsync(
            string id,
        ...
        /// <exception cref="MercadoPagoException">If a unexpected exception occurs.</exception>
        /// <exception cref="MercadoPagoApiException">If the API returns a error.</exception>
        public Resource.CardToken.CardToken Get(
            string id,
            RequestOptions requestOptions = null)
        {
            return Send(
