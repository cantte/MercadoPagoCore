...
namespace MercadoPagoCore.Client.IdentificationType
{
    /// <summary>
    /// Client with methods of Identification Type APIs.
    /// </summary>
    public class IdentificationTypeClient : MercadoPagoClient<Resource.IdentificationType.IdentificationType>
    {
        /// <summary>
        ...
        /// </remarks>
        public Task<ResourcesList<Resource.IdentificationType.IdentificationType>> ListAsync(
        ...
        /// <a href="https://www.mercadopago.com/developers/en/reference/identification_types/_identification_types/get/">here</a>.
        /// </remarks>
        public ResourcesList<Resource.IdentificationType.IdentificationType> List(
            RequestOptions requestOptions = null)
        {
            return List(
                "/v1/identification_types",
